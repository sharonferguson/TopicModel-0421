...
'''OLD FILE. Testing LDA with channel-day as documents''' 
...
data_words = list(sentence_to_words(comments_per_channel_per_day))
...
LDAvis_data_filepath = os.path.join('/Users/sharon/Documents/SlackData/LaurensScripts/Lda/'+ "channelday"+ str(num_topics))
...
pyLDAvis.save_html(LDAvis_prepared, '/Users/sharon/Documents/SlackData/LaurensScripts/Lda/'+ "channelday" + str(num_topics) +'.html')
LDAvis_prepared
